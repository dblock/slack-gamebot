...
**NOTE**: This project is deprecated in favor of [this fork](https://github.com/dblock/slack-gamebot2) that has been upgraded to work with Slack granular permission scopes and supports separate leaderboards in Slack channels.
